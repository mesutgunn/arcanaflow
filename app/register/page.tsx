...
import { Mail, Lock, Sparkles, Loader2, User } from "lucide-react";
        ...
        <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-cosmic-light/60">Create your cosmic account</p>
                </div>
                ...
                <div className="glass-card p-8">
                    ...
                    <form onSubmit={handleRegister} className="space-y-4">
                        ...
                        <div>
                            <label htmlFor="confirmPassword" className="block text-sm font-medium text-cosmic-light/80 mb-2">
                                Confirm Password
                            </label>
                            <div className="relative">
                                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-cosmic-glow/50" />
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-4 bg-cosmic-void text-cosmic-light/60">or sign up with</span>
                        </div>
                    </div>
                ...
                {/* Terms */}
                <p className="mt-6 text-center text-xs text-cosmic-light/40">
